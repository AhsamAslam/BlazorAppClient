...
namespace MyCommunityBuilder.Shared
{
    public class BusinessDto
    {
        ...
        public IAsyncEnumerable<BusinessCommentDto> businessCommentDto { get; set; }
        public IAsyncEnumerable<BusinessFileDto> businessFileDto { get; set; }
        public IAsyncEnumerable<FanDto> fanDto { get; set; }
